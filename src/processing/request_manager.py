...
class RequestManager:
    ...
    def get_request(self, request_id: str) -> FOIARequest | None:
        """Retrieve a specific request"""
        return self._requests.get(request_id)

    def get_active_request(self) -> FOIARequest | None:
    ...
    def update_request(self, request_id: str, **kwargs: Any) -> bool:
    ...
    def has_active_request(self) -> bool:
        ...
        return (
            ...
            and self._active_request_id in self._requests
        )
